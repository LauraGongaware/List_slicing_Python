...
first_three(input_list=['Jan', 'Feb', 'Mar', 'Apr', 'May'])
...
def last_five(input_list):
    ...
    return input_list[-5:]
    # print(input_list[-5:])
last_five(input_list=[0, 3, 6, 9, 12, 15, 18, 21, 24, 27])
...
inner_four(input_list=[0, 3, 6, 9, 12, 15, 18, 21, 24, 27])
...
inner_four_end(input_list=[0, 3, 6, 9, 12, 15, 18, 21, 24, 27])
...
def replace_head(input_list):
    ...
    input_list[0] = 42
    pass
replace_head(input_list=[0, 3, 6, 9, 12, 15, 18, 21, 24, 27])
...
def replace_third_and_last(input_list):
    ...
    input_list [-1] = 37
    pass
replace_third_and_last(input_list=[0, 3, 6, 9, 12, 15, 18, 21, 24, 27])
...
def replace_middle(input_list):
    ...
    pass
replace_middle(input_list=[0, 3, 6, 9, 12, 15, 18, 21, 24, 27])
...
def delete_third_and_seventh(input_list):
    ...
    pass
delete_third_and_seventh(input_list=['Do', 'Re', 'Mi', 'Fa', 'So', 'La', 'Ti', 'Do'])
